...
export async function AdminQuestionPanel({
  questionId,
  error,
}: {
  questionId: number;
  ...
  return (
    <div className="mt-8 rounded-lg border-2 border-dashed border-amber-300 bg-amber-50/40 p-4 dark:border-amber-700 dark:bg-amber-950/10">
      <div className="mb-3 flex flex-wrap items-center gap-3">
        <span className="rounded bg-amber-200 px-2 py-0.5 text-xs font-bold text-amber-900 dark:bg-amber-800 dark:text-amber-100">
          ניהול (מנהלים בלבד)
        </span>
        <Link href="/admin/questions" className="text-sm text-primary hover:underline">
          ← כל השאלות
        </Link>
        <Link
          href={`/admin/chapters/${q.chapter.number}/questions`}
      ...
      <div className="flex items-center justify-between mt-2">
        <h2 className="text-xl font-bold">שאלה #{q.id}</h2>
