  ...
  "group pointer-events-auto relative flex w-full items-start justify-between gap-3 overflow-hidden rounded-lg border p-4 pr-8 shadow-lg transition-all",
  {
    variants: {
      variant: {
        ...
        success:
          "border-success/30 bg-success/10 text-success-foreground dark:text-emerald-300",
      },
    },
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-transparent bg-secondary px-3 text-sm font-medium",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ...
    className={cn(
      ...
      "hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-1 group-hover:opacity-100",
      className
    )}
    toast-close=""
    {...props}
